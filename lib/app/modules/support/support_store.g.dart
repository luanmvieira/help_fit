...
mixin _$SupportStore on _SupportStoreBase, Store {
  late final _$userAtom =
      Atom(name: '_SupportStoreBase.user', context: context);
  ...
  late final _$loadUserAtom =
      Atom(name: '_SupportStoreBase.loadUser', context: context);
  ...
  late final _$getUserAsyncAction =
      AsyncAction('_SupportStoreBase.getUser', context: context);
